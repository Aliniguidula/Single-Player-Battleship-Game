...
public class EmptySea extends Ship {
     ...
     * hit array, based on the size of this Empty Sea (1 tiles).
     */
    public EmptySea(){
        this.length = 1;
    ...
    /**
     * Since an EmptySea is empty by definition,
     * shooting at one will always be a miss.
     *
    ...
    /**
     * Since an EmptySea is empty by definition,
     * it is not possible that one can be sunk.
     *
     * @return {@literal false} always, since nothing will be hit.
     */
    @Override
